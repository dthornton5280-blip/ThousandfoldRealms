...
check(composition.includes('prop_furniture_runtime_v169.js?v='),'composition must load a cache-busted authoritative prop runtime');
...
check(runtime.includes('generated-props-atlas-v166.b64?v='),'approved atlas must use a cache key');
...
console.log(`Authoritative prop/furniture integration preserved by ${version.version}: town nature removed; exterior, tavern, cellar, inn, seating, existing-save sync, and fallback behavior remain protected.`);